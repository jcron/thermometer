...
function setAmounts() {
    ...
    $("#sub-goal-right-2").text("$" + amounts[1].format());
    $("#sub-goal-left-3").text("$" + amounts[2].format());
...
// fireworks - http://jsfiddle.net/dtrooper/AceJJ/
...
// init
function launchFireworksWhenGoalIsMet() {
